    ...
    <div>
        ...
        <transition name="fade">
            <ul
                ...
                <li class="el-dropdown-menu__item" @click="addLicense(currentRow)" v-bind:class="{'is-disabled': currentRow.archive}">
                    <i class="el-icon-plus"></i> Добавить доп. соглашение
                </li>
...
export default {
    ...
    methods: {
        ...
        addLicense(row) {
            this.$router.push({path: this.redirectUrl + 'add-license', query: {contractId: row.id, contractName: row.number, folder: 'lessee_wagons/licenses'}});
        },
        view(id) {
