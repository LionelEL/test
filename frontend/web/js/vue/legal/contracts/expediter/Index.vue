                    ...
                    <div class="row">
                        <div class="col-sm-8 form-inline">
                            <div class="form-group">
                                <router-link to="/legal/expediter/create" class="btn btn-primary btn-flat btn-sm"><i class="fa fa-plus"></i> Создать</router-link>
                            </div>
...
export default {
    data() {
        return {
            ...
            redirectUrl: '/legal/expediter',
            userSettingsKey: 'legal-expediter-user-settings'
        }
    },
    created() {
