                    ...
                    <div class="row">
                        <div class="col-sm-8 form-inline">
                            <div class="form-group">
                                <router-link to="/legal/repair-ps/create" class="btn btn-primary btn-flat btn-sm"><i class="fa fa-plus"></i> Создать</router-link>
                            </div>
...
export default {
    data() {
        return {
            ...
            userSettingsKey: 'legal-repair-ps-user-settings'
        }
    },
    created() {
