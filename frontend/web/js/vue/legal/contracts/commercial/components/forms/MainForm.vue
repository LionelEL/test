...
<script>
// FIXME: Можно и нужно указывать алиасы (иначе при десктопном приложении ничего работать не будте)
// Например: эти записи можно было бы заменить на
// import StaticMixin from '@mixins/StaticMixin.js';
// import LoadFileComponent from '@common-components/LoadFileComponent.vue';
// Список доступных алиасов в файле webpack-aliases, их можно добавлять при необходимости
